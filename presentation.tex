...
\begin{description}
\tightlist
\item[Les billards, les cylindres discrets et les escaliers]
\centering\includegraphics[width=\textwidth,height=0.25\textheight]{img/billard-cylindre.png}\includegraphics[width=\textwidth,height=0.25\textheight]{img/escalier-recollement-variable.png}

\par
\item[La saga des Wind-trees]
...
\smallskip\centering\includegraphics[width=\textwidth,height=0.25\textheight]{img/3D-Kolibri-bicolore.jpg}\includegraphics[width=\textwidth,height=0.25\textheight]{img/3D-Herz-colorie.jpg}\includegraphics[width=\textwidth,height=0.25\textheight]{img/3D-Taube-coloriee.jpg}\includegraphics[width=\textwidth,height=0.25\textheight]{img/objets-3D-sur-echarpe-rouge.png}
...
\smallskip\centering\includegraphics[width=\textwidth,height=0.6\textheight]{img/bras-haptique.jpg}
...
\smallskip\centering\includegraphics[width=\textwidth,height=0.5\textheight]{img/Neticlab-Paysage-500x260.jpg}
...
\smallskip\centering\includegraphics[width=\textwidth,height=0.25\textheight]{img/kummer-photo.jpg}
...
\smallskip\centering\includegraphics[width=\textwidth,height=0.6\textheight]{img/screenshot-google-3d-printing-defects.png}
...
\smallskip\centering\includegraphics[width=\textwidth,height=0.25\textheight]{img/akiyama8hull3dprint-1.jpg}
...
\tightlist
\item
  j'ai déjà encadré un étudiant géomaticien de Paris 8 en alternance à
  l'Établissement Français du Sang
\item
  j'ai déjà enseigné deux cours en utilisant CoCalc, une plateforme
  collaborative en ligne qui se prête bien à la pédagogie inversée
\end{itemize}
...
\centering \includegraphics[width=\textwidth,height=0.1\textheight]{img/logo-sechilienne.png}

\par

Développeuse freelance chez BlueRidge Logiciels, 2016

\centering \includegraphics[width=\textwidth,height=0.2\textheight]{img/botte.jpg}
...
\centering \includegraphics[width=\textwidth,height=0.25\textheight]{img/pas-autruche.png}
